...
<div class="contenedor">
  <div id="signup-form" class="formulario">
    <a href="#/login">
  ...
  <div class="input-contenedor">
    ...
    <input class="input-init" type="email" id="signup-email" autocomplete="on" placeholder="E-mail" required />
  </div>
  <div class="input-contenedor">
    <i class="fas fa-key icon"></i>
    <input class="input-init" type="password" id="signup-password" placeholder="Contraseña"
      oninvalid="setCustomValidity('Tu contraseña debe tener min. 6 caracteres')" required />
  </div>
  <div class="input-contenedor">
